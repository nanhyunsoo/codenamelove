      ...
      <section className="mb-20 md:mb-28">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
          <div className="lg:w-2/5 shrink-0">
            <h3
              className="text-2xl md:text-3xl font-bold text-headline mb-4"
              style={{ fontFamily: 'Georgia, "Times New Roman", serif' }}
            >
          ...
          <div className="flex-1 w-full min-w-0">
            <div
              className="bg-input-card rounded-card p-6 shadow-elevation-2 text-input-card-text"
              style={{ minHeight: "200px" }}
            >
              <p className="text-sm font-medium text-chip-text mb-3">
                Onboarding
              </p>
              <div className="space-y-4">
                <div>
                  <label className="text-xs text-body-secondary block mb-1.5">
                    Relationship
                  </label>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["Nearby", "Same city", "Global"].map((opt) => (
                      <span
                        key={opt}
                        className="px-3 py-1.5 rounded-pill text-xs font-medium bg-chip-default border border-chip-border"
                      >
                        {opt}
                      </span>
                    ))}
            ...
            >
              <div className="space-y-3">
                <div className="flex gap-3">
                  <span className="w-8 h-8 rounded-full bg-accent-primary/30 shrink-0 flex items-center justify-center text-accent-primary text-xs font-bold">
                    A
                  </span>
                  <div className="bg-card-dark rounded-card px-3 py-2 text-body text-sm max-w-[85%]">
                    My owner is also a UX designer! Looking for someone in San
                    Francisco who likes fitness.
                  </div>
                </div>
                <div className="flex gap-3 justify-end">
                  <div className="bg-accent-primary/20 border border-accent-primary/50 rounded-card px-3 py-2 text-body text-sm max-w-[85%]">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
          ...
          <div className="flex-1 w-full min-w-0">
            <div
              ...
              style={{ minHeight: "200px" }}
            >
              <p className="text-xs text-body-secondary uppercase tracking-wide mb-2">
                Match Report
              </p>
              ...
              <button
                type="button"
                className="w-full rounded-pill bg-accent-primary text-cta-dark py-2.5 text-sm font-medium hover:bg-accent-hover transition-colors"
              >
                Start conversation
              </button>
            </div>
